...
class LangfuseExperimentPublisher:
    ...
    def check_connection(self) -> bool:
        """Check credentials without breaking the API."""
    ...
    def publish(
        ...
        """Publish an experiment without breaking it."""
        ...
        try:
            ...
            logger.exception(
                "Failed to publish experiment %s "
                "to Langfuse.",
        ...
        with self.client.start_as_current_observation(
            ...
            metadata={
                ...
                "application_versions": (
                    report.application_versions
                ),
                "evaluator_versions": (
                    report.evaluator_versions
                ),
            },
        ) as experiment_span:
    ...
    def _publish_case(
        ...
        with self.client.start_as_current_observation(
            ...
            for result in (
                case_result.evaluation.results
            ):
